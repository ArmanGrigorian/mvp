    ...
    const articles = [
        {
            ...
            summary: "A large shipment of essential medicines and medical equipment has successfully reached our distribution center in Yerevan.",
            featured: true,
        },
        {
            id: 2,
            ...
            summary: "Our team has completed the installation of solar-powered water pumps, providing clean water to over 2,000 residents.",
            featured: false,
        },
        {
            id: 3,
            ...
            summary: "We are starting our annual winter relief program to provide blankets and heating supplies to displaced families.",
            featured: false,
        },
        {
            id: 4,
            ...
            summary: "Thank you to all our donors! This year's gala raised $250,000 for emergency humanitarian aid.",
            featured: false,
        },
    ];
                ...
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2">
                        {articles.filter(a => a.featured).map(article => (
                            <article key={article.id} className="group relative overflow-hidden rounded-3xl bg-white shadow-xl">
                                ...
                                <div className="p-10">
                                    <div className="mb-4 flex items-center gap-4">
                                        ...
                                        <span className="text-foundation-navy/40 text-sm">{article.date}</span>
                                    </div>
                    ...
                    <div className="space-y-8">
                        {articles.filter(a => !a.featured).map(article => (
                            <article key={article.id} className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm transition-all hover:shadow-md">
                                <span className="text-foundation-navy/40 mb-2 block text-sm">{article.date}</span>
